...
%factory(storage::Device* storage::downcast, storage::Disk, storage::Md, storage::Partition,
	 storage::Gpt, storage::Msdos, storage::Btrfs, storage::Ext4, storage::Ntfs, storage::Swap,
	 storage::Vfat, storage::Xfs);

%factory(const storage::Device* storage::downcast, const storage::Disk, const storage::Md,
	 const storage::Partition, const storage::Gpt, const storage::Msdos, const storage::Btrfs,
