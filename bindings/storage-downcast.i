...
%factory(storage::Device* storage::downcast, storage::Disk, storage::Dasd, storage::Multipath,
	 storage::Md, storage::Partition, storage::Gpt, storage::DasdPt, storage::LvmPv,
	 storage::LvmVg, storage::LvmLv, storage::Luks, storage::Encryption, storage::Msdos,
	 storage::Btrfs, storage::BtrfsSubvolume, storage::Reiserfs, storage::Ext2, storage::Ext3,
	 storage::Ext4, storage::Ntfs, storage::Swap, storage::Vfat, storage::Xfs,
...
%factory(const storage::Device* storage::downcast, const storage::Disk, const storage::Dasd,
	 const storage::Multipath, const storage::Md, const storage::Partition,
