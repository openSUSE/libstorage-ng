...
%factory(storage::Device* storage::downcast, storage::Disk, storage::Md, storage::Partition,
	 ...
	 storage::Ext3, storage::Ext4, storage::Ext, storage::Ntfs, storage::Swap, storage::Vfat,
...
%factory(const storage::Device* storage::downcast, const storage::Disk, const storage::Md,
	 ...
	 const storage::Ext4, const storage::Ext, const storage::Ntfs, const storage::Swap,
	 const storage::Vfat, const storage::Xfs, const storage::Iso9660, const storage::Udf,
	 const storage::Bcache, const storage::BcacheCset);
