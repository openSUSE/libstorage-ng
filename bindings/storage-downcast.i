...
// TODO also for holders?

%include "factory.i"

// TODO don't repeat list of types, maybe possible with %define.

%factory(storage::Device* storage::downcast, storage::Disk, storage::Dasd, storage::Multipath,
	 storage::DmRaid, storage::Md, storage::Partition, storage::Gpt, storage::DasdPt,
	 storage::LvmPv, storage::LvmVg, storage::LvmLv, storage::Luks, storage::Encryption,
	 storage::Msdos, storage::Btrfs, storage::BtrfsSubvolume, storage::Reiserfs, storage::Ext2,
	 storage::Ext3, storage::Ext4, storage::Ntfs, storage::Swap, storage::Vfat, storage::Xfs,
	 storage::Iso9660, storage::Udf, storage::Bcache, storage::BcacheCset, storage::Nfs,
	 storage::MountPoint);

%factory(const storage::Device* storage::downcast, const storage::Disk, const storage::Dasd,
	 const storage::DmRaid, const storage::Multipath, const storage::Md, const storage::Partition,
	 const storage::Gpt, const storage::DasdPt, const storage::LvmPv, const storage::LvmVg,
	 const storage::LvmLv, const storage::Luks, const storage::Encryption,
	 ...
	 const storage::BcacheCset, const storage::Nfs, const storage::MountPoint);
