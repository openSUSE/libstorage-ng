...
BOOST_AUTO_TEST_CASE(parse_gpt_of_windows)
{
	...
	"num:1 region:[2048, 921600, 512 B] type:primary id:7",
	"num:2 region:[923648, 202752, 512 B] type:primary id:239",
	"num:3 region:[1126400, 32768, 512 B] type:primary id:259",
	"num:4 region:[1159168, 103696384, 512 B] type:primary id:258"
    };
