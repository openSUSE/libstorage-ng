...
namespace storage
{
    ...
    {
	shared_ptr<Md> md = make_shared<Md>(make_unique<Md::Impl>(name));
    ...
    {
	shared_ptr<Md> md = make_shared<Md>(make_unique<Md::Impl>(node));
    ...
    Md::Md(unique_ptr<Device::Impl>&& impl)
    ...
    Md::clone_v2() const
    {
	return make_unique<Md>(get_impl().clone());
    }
