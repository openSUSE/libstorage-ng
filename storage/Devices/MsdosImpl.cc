...
namespace storage
{
	...
	// The MS-DOS can address 2^32 sectors. We allow a maximum of
	// UINT32_MAX for length. As a consequence end is maximal UINT32_MAX -
	// 1 (although start can never be 0).
