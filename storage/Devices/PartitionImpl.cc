...
namespace storage
{
	...
	void
	SetPartitionId::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const Partition* partition = to_partition(get_device(commit_data.actiongraph, RHS));
	...
	void
	SetBoot::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const Partition* partition = to_partition(get_device(commit_data.actiongraph, RHS));
	...
	void
	SetLegacyBoot::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const Partition* partition = to_partition(get_device(commit_data.actiongraph, RHS));
