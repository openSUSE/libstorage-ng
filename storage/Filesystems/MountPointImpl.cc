...
namespace storage
{
    ...
    void
    MountPoint::Impl::do_mount(CommitData& commit_data, CommitOptions& commit_options) const
    {
	...
	void
	Mount::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const MountPoint* mount_point = to_mount_point(get_device(commit_data.actiongraph));
	...
	void
	Umount::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const MountPoint* mount_point = to_mount_point(get_device(commit_data.actiongraph));
	...
	void
	AddToEtcFstab::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const MountPoint* mount_point = to_mount_point(get_device(commit_data.actiongraph, RHS));
	...
	void
	UpdateInEtcFstab::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const MountPoint* mount_point_lhs = to_mount_point(get_device(commit_data.actiongraph, LHS));
	    const MountPoint* mount_point_rhs = to_mount_point(get_device(commit_data.actiongraph, RHS));
	...
	void
	RemoveFromEtcFstab::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const MountPoint* mount_point = to_mount_point(get_device(commit_data.actiongraph, LHS));
