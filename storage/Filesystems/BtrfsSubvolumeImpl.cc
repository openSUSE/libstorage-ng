...
namespace storage
{
	...
	void
	SetNocow::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const BtrfsSubvolume* btrfs_subvolume = to_btrfs_subvolume(get_device(commit_data.actiongraph, RHS));
	...
	void
	SetDefaultBtrfsSubvolume::commit(CommitData& commit_data, CommitOptions& commit_options) const
	{
	    const BtrfsSubvolume* btrfs_subvolume = to_btrfs_subvolume(get_device(commit_data.actiongraph, RHS));
