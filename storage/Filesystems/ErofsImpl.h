...
#ifndef STORAGE_EROFS_IMPL_H
#define STORAGE_EROFS_IMPL_H
...
namespace storage
{
    ...
    template <> struct DeviceTraits<Erofs> { static const char* classname; };


    class Erofs::Impl : public BlkFilesystem::Impl
    {

    public:

	virtual unsigned long long min_size() const override { return 0 * B; }
	virtual unsigned long long max_size() const override { return 1 * EiB; }
	...
	virtual FsType get_type() const override { return FsType::EROFS1; }

	virtual const char* get_classname() const override { return DeviceTraits<Erofs>::classname; }

	virtual string get_pretty_classname() const override;

	virtual string get_displayname() const override { return "erofs"; }
