...
namespace storage
{
    ...
    /**
     * Finds the device impl corresponding to original impl in devicegraph.
     */
    template<class Type>
    const Type&
	...
	return dynamic_cast<const typename Type::non_impl_type*>(device)->get_impl();
    }


    /**
     * Finds the device impl corresponding to original impl in the probed
     * devicegraph.
     */
    template<class Type>
    const Type&
    ...
    {
	const Devicegraph* probed = original.get_storage()->get_probed();
