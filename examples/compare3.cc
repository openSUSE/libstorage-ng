...
main()
{
    ...
    DeviceGraph::vertex_descriptor system_v1_rhs = rhs.find_vertex(lhs.graph[system_v1]->sid);
    DeviceGraph::vertex_descriptor system_v1_root_rhs = rhs.find_vertex(lhs.graph[system_v1_root]->sid);
    DeviceGraph::vertex_descriptor system_v1_swap_rhs = rhs.find_vertex(lhs.graph[system_v1_swap]->sid);
    DeviceGraph::vertex_descriptor system_v1_root_fs_rhs = rhs.find_vertex(lhs.graph[system_v1_root_fs]->sid);
    DeviceGraph::vertex_descriptor system_v1_swap_fs_rhs = rhs.find_vertex(lhs.graph[system_v1_swap_fs]->sid);
    ...
    DeviceGraph::vertex_descriptor sda1_rhs = rhs.find_vertex(lhs.graph[sda1]->sid);
